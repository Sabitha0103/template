...
const Departments: React.FC = () => {
    ...
    return (
        <section id="departments" ref={ref} className="section-y-lg bg-warm-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full text-center pointer-events-none select-none z-0 pt-10">
                <span className="font-sans font-bold text-[15vw] leading-none text-neutral-900/[0.03] whitespace-nowrap mix-blend-multiply">
                    ACADEMICS
                </span>
            </div>
            ...
            <div className="section-container relative z-10">
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <div className="group bg-white rounded-2xl shadow-md hover:shadow-xl overflow-hidden transition-all duration-500 flex flex-col lg:flex-row border border-neutral-100 relative">
                        {/* Absolute Top Accent */}
                            ...
                            <div className="mb-10 lg:mb-0">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {featuredDept.researchAreas.map(area => (
                                        <span key={area} className="px-3 py-1.5 bg-warm-50 border border-neutral-200 text-neutral-600 text-[12px] font-medium rounded-full">
                                            {area}
                                        </span>
                                    ))}
                                </div>
                    ...
                    {standardDepts.map((dept, i) => (
                        ...
                        >
                            <Link
                                ...
                                className="group block bg-white h-full rounded-2xl shadow-sm hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] overflow-hidden transition-all duration-500 border border-neutral-100 relative"
                            >
