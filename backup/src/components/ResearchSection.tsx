            ...
            <div className="max-w-[1200px] mx-auto px-6 py-20 lg:py-28">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-14 gap-y-16 reveal-stagger">
                    {facilities.map((f) => (
                        <div key={f.num} className="reveal">
                            <span className="font-serif text-4xl lg:text-5xl font-bold text-neutral-200/70">
                                {f.num}
                            </span>
                            <h3 className="heading-3 text-neutral-dark mt-4 mb-1">
                                {f.title}
                            </h3>
                            <div className="w-8 h-px bg-primary/25 mb-3" />
                ...
                <div className="mt-20 lg:mt-28 pt-12 border-t border-neutral-200 reveal">
                    <div className="relative max-w-3xl">
                        ...
                        <span className="absolute -top-6 -left-4 lg:-left-10 font-serif text-[6rem] lg:text-[8rem] text-primary/8 leading-none select-none pointer-events-none">
                            "
                        </span>
